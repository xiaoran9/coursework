...
public class part1_newChar {
	public static  BasicNetwork netwokrSet() {
		int inputUnits =7;
		int hiddenUnits =7;//not sure
		int outputUnits = 3;
	...
	public static MLDataSet readCSV(){
		...
		MLDataPair pair = addCharacter.newChar();
		for(int i=0;i<5;i++)
		{
			result.add(pair);
		}
	...
	public static void setNewNet(){
		BasicNetwork network = netwokrSet();
		System.out.println("Saving network");
		EncogDirectoryPersistence.saveObject(new File("AddCha_network.eg"), network);
